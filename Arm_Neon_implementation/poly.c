...
**************************************************/
extern void __asm_poly_add(int32_t*, int32_t*, int32_t*);
extern void __asm_poly_add2(int32_t*, int32_t*, int32_t*);
void poly_add(poly *c, const poly *a, const poly *b)  {
  unsigned int i;
  DBENCH_START();


  __asm_poly_add2(c->coeffs, a->coeffs, b->coeffs);
...
**************************************************/
extern void __asm_poly_sub(int32_t*, int32_t*, int32_t*);
extern void __asm_poly_sub2(int32_t*, int32_t*, int32_t*);
void poly_sub(poly *c, const poly *a, const poly *b) {
  unsigned int i;
  DBENCH_START();


  __asm_poly_sub2(c->coeffs, a->coeffs, b->coeffs);
...
* Arguments:   - poly *a: pointer to input/output polynomial
**************************************************/
extern void __asm_poly_shiftl(int32_t*);
void poly_shiftl(poly *a) {
  unsigned int i;
  DBENCH_START();


  __asm_poly_shiftl(a->coeffs);
