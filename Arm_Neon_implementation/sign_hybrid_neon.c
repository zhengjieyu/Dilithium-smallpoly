 ...
 * Returns 0 (success)
 **************************************************/
int hybrid_neon_crypto_sign_signature(uint8_t *sig,
                                      size_t *siglen,
                                      const uint8_t *m,
                                      size_t mlen,
                                      const uint8_t *sk)
 ...
 * Returns 0 (success)
 **************************************************/
int hybrid_neon_crypto_sign(uint8_t *sm,
                            size_t *smlen,
                            const uint8_t *m,
                            size_t mlen,
                            const uint8_t *sk)
{
  ...
  hybrid_neon_crypto_sign_signature(sm, smlen, sm + CRYPTO_BYTES, mlen, sk);
  *smlen += mlen;
  return 0;
}
 ...
 **************************************************/
int hybrid_neon_crypto_sign_verify(const uint8_t *sig,
                                   size_t siglen,
                                   const uint8_t *m,
                                   size_t mlen,
                                   const uint8_t *pk)
 ...
 **************************************************/
int hybrid_neon_crypto_sign_open(uint8_t *m,
                                 size_t *mlen,
                                 const uint8_t *sm,
                                 size_t smlen,
                                 const uint8_t *pk)
{
  ...
  *mlen = smlen - CRYPTO_BYTES;
  if (hybrid_neon_crypto_sign_verify(sm, CRYPTO_BYTES, sm + CRYPTO_BYTES, *mlen, pk))
    goto badsig;
  else
  {
